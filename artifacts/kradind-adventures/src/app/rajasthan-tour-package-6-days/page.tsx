...
import { RajasthanTourClient } from "./rajasthan-client";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://kradind.com/rajasthan-tour-package-6-days",
  },
  openGraph: {
    title: "Rajasthan Tour Package – 6 Days | Jaipur Jodhpur Udaipur",
    description:
      "Book a 6-day Rajasthan tour covering Jaipur, Jodhpur & Udaipur with private car, 3-star stays and meals. Get your Rajasthan trip quote today.",
    url: "https://kradind.com/rajasthan-tour-package-6-days",
...
export default function RajasthanTourPackagePage() {
  const pageUrl = "https://kradind.com/rajasthan-tour-package-6-days";
  ...
  const tripSchema = {
    ...
    itinerary: [
      {
        "@type": "Day",
        name: "Day 1: Jaipur Arrival & Pink City Sightseeing",
        description: "Arrival in Jaipur, transfer to hotel, visit City Palace, Jantar Mantar, Hawa Mahal and Old City Bazaars.",
      },
      {
        "@type": "Day",
        name: "Day 2: Jaipur Forts & City Sightseeing",
        description: "Explore Amber Fort, Jaigarh Fort, Jal Mahal photo stop, Nahargarh Fort sunset view and Birla Mandir.",
      },
      {
        "@type": "Day",
        name: "Day 3: Jaipur to Jodhpur",
        description: "Scenic road journey to Jodhpur (~340 km), Clock Tower, Sardar Market, and blue-painted old city lanes.",
      },
      {
        "@type": "Day",
        name: "Day 4: Jodhpur Forts, Palaces & Old City",
        description: "Full day in Jodhpur: Mehrangarh Fort, Jaswant Thada, Umaid Bhawan Palace museum and Mandore Gardens.",
      },
      {
        "@type": "Day",
        name: "Day 5: Jodhpur to Udaipur via Ranakpur",
        description: "Drive to Udaipur via Ranakpur Jain Temple, evening lakeside stroll at Lake Pichola and Gangaur Ghat.",
      },
      {
        "@type": "Day",
        name: "Day 6: Udaipur Sightseeing & Departure",
        description: "Visit Udaipur City Palace, Jagdish Temple, Saheliyon Ki Bari, Fateh Sagar Lake and transfer to Airport/Station.",
      },
    ],
    provider: {
      "@type": "TravelAgency",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 4,
        name: "Rajasthan Tour Package – 6 Days",
        item: pageUrl,
      },
    ],
  };
