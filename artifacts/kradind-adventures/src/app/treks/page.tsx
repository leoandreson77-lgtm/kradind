    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 mt-3 brand-font tracking-tight">
            Curated Indian Treks & Tour Packages
          </h1>
          <p className="text-slate-600 text-sm sm:text-base mt-2 leading-relaxed">
            Handpicked Himalayan treks, peaceful backwaters, heritage desert tours, and Northeast escapes with certified tour leads and transparent pricing.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between text-xs text-slate-500 mb-4 px-1">
          <span>Showing <strong>{filteredTreks.length}</strong> verified trips</span>
          {searchQuery && (
            <button
        ...
        {filteredTreks.length === 0 && (
          <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 mt-6 space-y-3">
            ...
            <h3 className="text-lg font-bold text-slate-700">No destinations match your filter</h3>
...
export default function TreksPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50 flex items-center justify-center text-xs text-slate-500">Loading catalog...</div>}>
      <TreksContent />
    </Suspense>
  );
}
